...
all: kenken
kenken: obj/GUI-kenken.o obj/kenken-solver.o obj/kenken-basic.o obj/menu.o obj/save-kenken.o
	$(CC) $(CFLAGS) -o kenken obj/kenken-basic.o obj/kenken-solver.o obj/menu.o obj/save-kenken.o obj/GUI-kenken.o $(LDLIBS)
...
obj/menu.o: src/menu.c inc/menu.h inc/GUI-kenken.h
	$(CC) -c $(CFLAGS) src/menu.c -o obj/menu.o -DFILEPATH=\"$(CURDIR)\"
...
clean:
	rm -f kenken obj/kenken-basic.o obj/kenken-solver.o obj/GUI-kenken.o obj/menu.o obj/save-kenken.o
